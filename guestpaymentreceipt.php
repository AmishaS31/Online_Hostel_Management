...
<br>
			...
			<div class="col-sm-12">
			<center<div style="font-size:16px;"><b>Received from Miss./Mr.  <u ><?php echo $rsadmission['name']; ?></u> Collected Amount <u >₹<?php echo $rsbilling[4]; ?></u>  from <u><?php echo date("d-M-Y",strtotime($particulars[0])); ?></u>  to <u ><?php echo date("d-M-Y",strtotime($particulars[1])); ?></u></b></div></center>
			</div>
	</div>
