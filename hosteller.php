...
<form action="" method="post" class="register-wthree" name="frmform" onsubmit="return validateform()">
	...
	<div class="row">
		<div class="col-lg-6">
			...
			<select name="hostellertype" class="form-control" id="hostellertype" >
				<option value=""  ></option>
				<?php
				$arr = array("Student");
				foreach($arr as $val)
...
function validateform()
{
	...
	{
		document.getElementById("idhostellertype").innerHTML = "Name should not be empty...";
		document.getElementById("hostellertype").focus();
		errstatus = "false";
	}
