...
if(isset($_POST['submit']))
{
	...
	if(mysqli_affected_rows($con) ==1 )
	{
		...
		echo "<script>viewmessagebox('Feedback published successfully....','viewfeedback.php')</script>";
	}
}
?>
	</div>
...
<form action="" method="post" class="register-wthree" name="frmform" onsubmit="return validateform()" >
	...
	<div class="row">
		...
		<div class="col-lg-12">
			...
			<input class="form-control"  type="text" name="feedbacktitle" required="required" >
		</div>
	</div>
	<div class="form-group">
		...
		<textarea name="feedbackmessage" class="form-control" required="required"></textarea>
	</div>
