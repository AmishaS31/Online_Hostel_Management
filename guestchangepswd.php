...
<form action="" method="post" class="register-wthree"  name="frmform" onsubmit="return validateform()">
	<div class="form-group">
		...
		<input class="form-control" type="password" name="opassword" maxlength="8" value="<?php echo $rsedit['password'];?>" required="required">
	</div>
	<div class="form-group">
		<label>
			New password
		</label><span class="errclass" id="idpassword"></span>
		<input class="form-control" type="password" name="npassword" maxlength="8" value="<?php echo $rsedit['password'];?>" required="required" >
	</div>
	<div class="form-group">
		<label>
			Confirm password
		</label><span class="errclass" id="idcpassword"></span>
		<input class="form-control" type="password" name="cpassword" maxlength="8" placeholder="Confirm Password" value="<?php echo $rsedit['password'];?>" required="required">
	</div>
