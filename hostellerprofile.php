...
<form action="" method="post" name="frmform" id="frmform" class="register-wthree" onsubmit="return validateform()">
	...
	<div class="row">
		...
		<br>
			...
			<input class="form-control" type="date" placeholder="DOB" name="dob" id="dob"  min="1980-01-01" max="2003-01-01"value="<?php echo $rsedit['dob'];?>"  max="<?php echo date("Y-m-d",strtotime("-15 year")); ?>">
		</div>
	</div>
	...
	<div class="row">
		...
		<br>
			...
			<input class="form-control"  type="text" name="father_name" id="father_name" maxlength="15" value="<?php echo $rsedit['father_name'];?>">
		</div>
		<div class="col-lg-6">
		<br>
			<label>
			...
			<input class="form-control"  type="text" name="mother_name" maxlength="15" id="mother_name" value="<?php echo $rsedit['mother_name'];?>">
		</div>
	</div>
	...
	<div class="form-group">
		...
		<input class="form-control"  type="text" name="contact_no" id="contact_no" maxlength="10"value="<?php echo $rsedit['contact_no'];?>">
	</div>
...
//		 emailid dob father_name mother_name address contact_no
	...
	if(!document.frmform.mother_name.value.match(alphaSpaceExp))
	{
		document.getElementById("idmother_name").innerHTML = "Entered name is not valid...";
