     ...
     <h1 class="logo"><a href="index.html">Online Hostel Management</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Hosteller</span>
         ...
         <div class="col-lg-6">
          <form onsubmit="return check()">
			...
			<label for="name">Name</label>
                  <input type="text" name="name" class="form-control" id="name" pattern="[a-zA-Z'-'\s]*" title="only alphabets" placeholder="Your Name" required >
                  <div id="name" class="emsg"></div>
                </div>
			...
			<label for="email">
				Email
                  ...
                  <input type="email" class="form-control" name="email"  pattern="/^[\w\-\.\+]+\@[a-zA-Z0-9\.\-]+\.[a-zA-z0-9]{2,4}$/;"  title="Enter valid email id" id="email" placeholder="Your Email" required >
			...
			<label for="subject">
                ...
                <input type="text" class="form-control" name="subject" pattern="[a-zA-Z'-'\s]*" title="Enter alphabets only" id="subject" placeholder="Subject"  required>
              </div>
              <div class="form-group mt-3">
			...
			<label for="msg">
                ...
                <textarea class="form-control" name="msg" rows="5" pattern="[a-zA-Z'-'\s]*" title="only alphabets" id="msg"placeholder="Message"  required></textarea>
              </div>
