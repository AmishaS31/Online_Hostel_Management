...
?>
	...
	<tbody>
	<?php
	$sql ="SELECT  * from leave_application LEFT JOIN hosteller ON leave_application.hostellerid=hosteller.hostellerid WHERE 0=0";	
	if(isset($_SESSION['hostellerid']))
	{
		$sql = $sql . " AND leave_application.hostellerid='" . $_SESSION['hostellerid'] . "'";
	}
	$qsql = mysqli_query($con,$sql);
